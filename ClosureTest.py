...
#---Loop over event ---#
	...
	for iev in inputNtuples:
		...
		for i_gen in range(0,iev.nMcParticles_pc) :
			if abs(iev.type_mcParticle_pc[i_gen]) == 13 and abs(iev.motherType_mcParticle_pc[i_gen]) ==  1000006 and abs(iev.d0BeamSpot_mcParticle_pc[i_gen])<10: # gen muon
		...
		#for iele_gen in range(0,iev.nMcParticles_pc):
			if abs(iev.type_mcParticle_pc[i_gen]) == 11 and abs(iev.motherType_mcParticle_pc[i_gen]) ==  1000006 and abs(iev.d0BeamSpot_mcParticle_pc[i_gen])<10:
...
#-------Alternative Way----------#
	...
	for iev in inputFiles:
		if abs(iev.d0BeamSpot_muon[0])<10 and abs(iev.d0BeamSpot_electron[0])<10:			
			nevents+=1
			if ii>100:
				continue
...
print "m200:[0.69, 0.74, 1.24]"
print "m500:[0.67, 0.73, 1.04]"
print "m800:[0.68, 0.70, 1.08]"
print "m1100:[0.71, 0.73, 1.12]"
